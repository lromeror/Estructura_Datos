...
public class ArrayList<E> implements List<E> {
    ...
    //Lograoms estandarizar los elementos de una lista
    //Esto si nos interesa
    @Override
    public Iterator<E> iterator() {//Esto es un metodo que retorna una interfaz, pero sabemos que no podemos hacer por lo tanto 
        //Usamos una Inner Class
